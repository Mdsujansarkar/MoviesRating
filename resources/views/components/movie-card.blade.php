...
<a href="{{ route('movies.show', $popularMovie['id'])}}">
    <img src="{{$popularMovie['poster_path']}}" alt="profile image" class="hover:opacity-75 transition ease-in-out duration-150">
</a>
<div class="mt-2">
    <a href="{{ route('movies.show', $popularMovie['id'])}}" class="text-lg hover:text-gray-300">{{$popularMovie['title']}}</a>
