<div class="relative mt-3 md:mt-0 items-center">
	<div class="md:ml-4 mt-3 md:mt-0">
		<input type="text" wire:model="search" class="bg-gray-800 text-sm rounded-full w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Search (Press '/' to focus)" />
		...
		<div class="z-50 absolute bg-gray-800 text-sm rounded w-64 mt-4">
            @if ($searchReasult->count() > 0)
               <ul>
				
				@foreach ($searchReasult as $result)
